...
public partial class Testing
{
    ...
    {
        return await RunAsUserAsync("user@localhost", "User111!", Array.Empty<string>());
    }

    public static async Task<string> RunAsAdministratorAsync()
    {
        return await RunAsUserAsync("superadmin@localhost", "SuperAdmin1!", new[] { RolesConstants.SuperAdmin });
    }
