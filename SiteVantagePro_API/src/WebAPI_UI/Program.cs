using SiteVantagePro_API.WebAPI_UI.Components;
using SiteVantagePro_API.WebAPI_UI.Client.Pages;
...
public partial class Program
{
    public static async Task Main(string[] args)
    {
        ...
        try
        {
            await Task.Delay(1); //only used so I can comment out below when needed ... after initial deployment below
