...
using WebWasmBlazor.Identity.Models;
    ...
    public class CookieAuthenticationStateProvider : AuthenticationStateProvider, IAccountManagement
    {
        ...
        public async Task<FormResult> LoginAsync(string email, string password)
        {
            try
            {
                // login with cookies
                var result = await _httpClient.PostAsJsonAsync(
                    "Users/login?useCookies=true", new
                    {
                        email,
                        password
                    });
            ...
            catch (Exception ex)
            {
                ...
                var inMsgException = ex.InnerException;
            }
        ...
        public override async Task<AuthenticationState> GetAuthenticationStateAsync()
        {
            ...
            try
            {
                ...
                var userResponse = await _httpClient.GetAsync("Users/manage/info"); //https://localhost:7087/Users/manage/info
                ...
                if (userInfo != null)
                {
                    ...
                    //Update removed Claims dictionary from UserReponse!!!!
